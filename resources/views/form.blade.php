      ...
      <div class="col-6">
        <form id="logout-form" action="{{ route('phone-insert') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input name="surname" type="text" class="form-control" id="password" placeholder="Введите фамилию">
              </div>
            ...
            <div class="form-group">
              ...
              <input name="patronymic" type="text" class="form-control" id="patronymic" placeholder="Введите Отчество">
            </div>
